...
def bets(round_poker):
    ...
    while True:
        ...
        if round_poker == 'флоп':
            ...
            if (bet_human == bet_comp) or (my_money - bet_human == 0 and whose_stack_is_first == 'human') or \
                    (opponent_money - bet_comp == 0 and whose_stack_is_first == 'comp'):
                break
...
print()
print("\033[1m\033[35m" + 'Мои деньги: ' + str(my_money), end='     ')
...
while True:
    ...
    if not fold:
        if winer == 'human':
            ...
            low = 'human'
            opponent_money += oll_bank
    print("\033[3m\033[35m" + 'Мои деньги: ' + str(my_money), end='     ')
    print('Деньги компьютера: ' + str(opponent_money) + "\033[0m")
    print()
    first_game = 1
    time.sleep(2)
